...
#Open File
png(filename="/Users/nikolaoslamprou/Desktop/Data Science/plot4.png",width = 480, height = 480, units = "px")
#Plot
par(mfrow=c(2,2))
plot(input$Time,input$Global_active_power,type="l",ylab="Global Active Power",xlab="")
plot(input$Time,input$Voltage,type="l",ylab="Voltage",xlab="datetime")
...
legend('topright', names(input[,7:9]),bty = "n",lty=1, col=c('black', 'red', 'blue'), cex=.75)
plot(input$Time,input$Global_reactive_power,type="l",ylab="Global Reactive Power",xlab="datetime")
#Close file
dev.off()