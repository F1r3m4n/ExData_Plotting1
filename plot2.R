...
#Open File
png(filename="/Users/nikolaoslamprou/Desktop/Data Science/plot2.png",width = 480, height = 480, units = "px")
#Plot
plot(input$Time,input$Global_active_power,type="l",ylab="Global Active Power (kilowatts)",xlab="")
dev.off()